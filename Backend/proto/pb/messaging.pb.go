...
func (x *GetOnlineStatusResponse) GetLastSeen() string {
	if x != nil {
		return x.LastSeen
	}
	return ""
...
const file_messaging_proto_rawDesc = "" +
	...
	"\x17GetOnlineStatusResponse\x12\x1b\n" +
	"\tis_online\x18\x01 \x01(\bR\bisOnline\x12\x1b\n" +
	"\tlast_seen\x18\x02 \x01(\tR\blastSeen2\xd2\x02\n" +
	...
	"\x0eStreamMessages\x12 .messaging.StreamMessagesRequest\x1a\x12.messaging.Message0\x01\x12X\n" +
	"\x0fGetOnlineStatus\x12!.messaging.GetOnlineStatusRequest\x1a\".messaging.GetOnlineStatusResponseB+Z)github.com/prachin77/insight-hub/proto/pbb\x06proto3"
...
var file_messaging_proto_goTypes = []any{
	...
	(*GetOnlineStatusRequest)(nil),  // 6: messaging.GetOnlineStatusRequest
	(*GetOnlineStatusResponse)(nil), // 7: messaging.GetOnlineStatusResponse
}
var file_messaging_proto_depIdxs = []int32{
	...
	6, // 5: messaging.MessagingService.GetOnlineStatus:input_type -> messaging.GetOnlineStatusRequest
	...
	0, // 8: messaging.MessagingService.StreamMessages:output_type -> messaging.Message
	7, // 9: messaging.MessagingService.GetOnlineStatus:output_type -> messaging.GetOnlineStatusResponse
